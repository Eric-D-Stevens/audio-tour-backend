...
def save_script_to_s3(
    ...
    # Define S3 key for the script using the tours prefix structure with tour type in filename
    script_key = f"tours/{place_id}/script/{tour_type.value}_script.txt"
