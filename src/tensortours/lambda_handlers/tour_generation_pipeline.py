        ...
        if "photos" in place_details:
            ...
            def process_photo(photo_data, index):
                ...
                try:
                    ...
                    # Define S3 key for the photo using the requested format
                    photo_key = f"photos/{place_id}_{index}.jpg"
...
def audio_generator_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        # Define S3 key for the audio using the requested format
        audio_key = f"audio/{place_id}_{tour_type.value}_audio.mp3"
